...
//    CodeScannerView codeScannerView;
    private com.example.accidentreporter.SharedViewModel viewModel;
    TextView tv;
    String x = null;
...
//                                com.example.accidentapp.AddAccidentFragment fragmentc = new com.example.accidentapp.AddAccidentFragment();
...
//
//                            } else {
//                                getParentFragmentManager().beginTransaction().replace(R.id.container, new com.example.accidentapp.AddAccidentFragment()).commit();
//                                Toast.makeText(getActivity(), "Invalid Id , Scan correct Id provided by the app !", Toast.LENGTH_SHORT).show();
//                            }
//
//
//                        } else if (x != null && x.equalsIgnoreCase("2")) {
//
//                            if (Patterns.EMAIL_ADDRESS.matcher(result.getText().toString().trim()).matches()) {
//
//                                com.example.accidentapp.ChatFragment fragmentd = new com.example.accidentapp.ChatFragment();
//                                args.putString("qrscan", result.getText());
//                                args.putString("id", "2");
...
//
//                            } else {
//                                getParentFragmentManager().beginTransaction().replace(R.id.container, new com.example.accidentapp.ChatFragment()).commit();
//                                Toast.makeText(getActivity(), "Invalid Id , Scan correct Id provided by the app !", Toast.LENGTH_SHORT).show();
//                            }
//
//
