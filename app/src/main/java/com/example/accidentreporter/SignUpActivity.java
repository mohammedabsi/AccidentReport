...
public class SignUpActivity extends AppCompatActivity {
    ...
    public void returnLogin(View view) {
        Intent intent = new Intent(this, com.example.accidentreporter.SignInActivity.class);
        startActivity(intent);
        finish();
    }

    public void goHomeActivity() {
        Intent intent = new Intent(this, com.example.accidentreporter.MainActivity.class);
        startActivity(intent);
        finish();
    }
                    ...
                    mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                com.example.accidentreporter.User user = new com.example.accidentreporter.User(user_name, password, email, date);
