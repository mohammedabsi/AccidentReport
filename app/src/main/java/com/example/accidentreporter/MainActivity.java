...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction().replace(R.id.container, new com.example.accidentreporter.MainFragment()).commit();
            Log.d("TAG", "onCreate: " + getSupportFragmentManager().getFragments().contains(new com.example.accidentreporter.MainFragment()));
        }
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.nav_profile:
                        ...
                        getSupportFragmentManager().beginTransaction().replace(R.id.container, new com.example.accidentreporter.ProfileFragment()).commit();
                        break;
...
//                        break;
                    ...
                    case R.id.nav_logout:
                        ...
                        startActivity(new Intent(MainActivity.this, com.example.accidentreporter.SignInActivity.class));
                        finish();
