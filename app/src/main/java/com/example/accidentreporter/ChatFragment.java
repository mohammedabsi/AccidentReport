                ...
                if (!acident_address_dialog.getText().toString().trim().isEmpty()) {
                    if (!time_dialog.getText().toString().trim().isEmpty()) {
                        if (!carplate_dialog.getText().toString().trim().isEmpty()) {
                            com.example.accidentreporter.AccidentDetails accidentDetails = new com.example.accidentreporter.AccidentDetails(time_dialog.getText().toString().trim(), acident_address_dialog.getText().toString().trim(), carplate_dialog.getText().toString().trim(), user_id2.getText().toString().trim(), currentemail);
