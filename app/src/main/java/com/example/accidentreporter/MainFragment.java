        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                ...
                case R.id.joinAcc:
                    ...
                    getParentFragmentManager().beginTransaction().replace(R.id.container, new com.example.accidentreporter.ChatFragment()).addToBackStack(null).commit();

                    break;
                case R.id.addAcc:
                    intent.putExtra("accident", "2");
                    getParentFragmentManager().beginTransaction().replace(R.id.container, new com.example.accidentreporter.AddAccidentFragment()).addToBackStack(null).commit();
